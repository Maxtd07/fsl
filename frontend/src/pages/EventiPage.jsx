...
function getViewModeButtonClassName(isActive) {
  return `rounded-lg px-4 py-2 text-sm font-semibold ${
    isActive ? 'bg-primary/20 text-primary' : 'border border-primary/20 text-text/70 hover:bg-primary/10'
  }`
}
  ...
  return (
    <main>
      <PageHero
        ...
        description="Scopri le attivita dell associazione, iscriviti agli eventi e gestisci tutto dal tuo account personale. Ricevi aggiornamenti, conferme automatiche e integra facilmente gli appuntamenti nel tuo calendario."
        tone="primary"
        actions={
          <>
      ...
      <section className="border-primary/15 px-6 py-10 lg:py-12">
        <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <SectionHeading
            ...
            description="Scopri e iscriviti ai nostri eventi dedicati a famiglie e persone con disabilita."
          />
