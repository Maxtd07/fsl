...
const navLinkClasses =
  'rounded-full border px-4 py-2 text-sm font-medium leading-6 transition duration-200 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/30 focus-visible:ring-offset-2 focus-visible:ring-offset-base'

function Navbar() {
  const [isOpen, setIsOpen] = useState(false)

  return (
    <div className="rounded-[1.75rem] border-2 border-primary/20 bg-base/90 px-5 py-5 shadow-[0_12px_28px_rgba(0,0,0,0.08)] backdrop-blur-sm md:px-6">
        ...
        <div className="flex items-center justify-between">
          <div className="max-w-2xl">
            ...
            >
              <span
                aria-hidden="true"
                className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-[1rem] border-2 border-primary/20 bg-primary/8"
              >
      ...
      <nav
        className={`flex flex-col gap-2 border-t border-primary/15 pt-4 md:flex-wrap md:flex-row ${
