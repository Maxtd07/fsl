    ...
    <article className="flex h-full flex-col overflow-hidden rounded-[1.5rem] border border-primary/20 bg-base shadow-[0_12px_28px_rgba(0,0,0,0.08)]">
      ...
      <div className="flex flex-1 flex-col p-4">
        <div className="flex flex-wrap items-center gap-2">
          <span className="inline-flex rounded-full bg-primary/8 px-3 py-1 text-[0.68rem] font-bold uppercase tracking-[0.18em] text-primary">
        ...
        <h3 className="mt-3 text-base font-bold tracking-[-0.02em] text-text">{member.name}</h3>

        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border border-primary/15 bg-background px-4 py-3">
            <p className="text-[0.68rem] font-bold uppercase tracking-[0.18em] text-text/55">
          ...
          {player && (
            <div className="rounded-2xl border border-primary/15 bg-background px-4 py-3">
              <p className="text-[0.68rem] font-bold uppercase tracking-[0.18em] text-text/55">Numero maglia</p>
